...
public class FCInGameHopper
{
	...
	public static boolean closeHopper()
	{
		...
		if(CLOSE_BUTTON != null && Clicking.click(CLOSE_BUTTON))
			return Timing.waitCondition(RedConditions.interfaceNotUpCondition(HOPPER_MASTER), 1500);
	...
	{
		if(Clicking.hover(targetWorld) && Timing.waitCondition(RedConditions.uptextContainsCondition(""+worldNum), 1000))
		{
			Mouse.click(1);
